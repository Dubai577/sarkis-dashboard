...
/**
 * Preserved from Release 0 but not currently rendered — see lib/portal/status.ts.
 * Release 5 rebuilds the portal (hashed session tokens, expiry, a sessions
 * table, one-way PIN hashing, rate limiting) and this form comes back with it.
 */
export default function PortalPinForm() {
