...
/**
 * "2h ago", "3d ago", for an ISO instant.
 *
 * Lives here rather than in a component because it is the only place time is
 * reasoned about, and because an inline version in a component is exactly
 * the kind of date arithmetic this module exists to keep out of the UI.
 */
